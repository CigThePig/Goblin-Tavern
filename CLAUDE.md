...
>
> The **Simulation Expansion and Obligation-Closure plan** is the only unpaused work. It is a standalone implementation document — no earlier audit, report, or conversation is needed to execute it — and it runs as **ISSUE-170…183 (repo phases 207–220)**, one issue per plan phase 0–13. **ISSUE-170…176 (Phases 0–6) are done — next is ISSUE-177 (Phase 7 — loans, tenancy, regulation, inspections).** `OBL-01` and `OBL-04` are closed and so is the staff half of `OBL-02`; Phase 5 also absorbs and closes ISSUE-168.
>
