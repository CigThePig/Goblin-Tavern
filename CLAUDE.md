...
>
> The **Simulation Expansion and Obligation-Closure plan** is the only unpaused work. It is a standalone implementation document — no earlier audit, report, or conversation is needed to execute it — and it runs as **ISSUE-170…183 (repo phases 207–220)**, one issue per plan phase 0–13. **ISSUE-170…175 (Phases 0–5) are done — next is ISSUE-176 (Phase 6 — transactional suppliers: orders, deliveries, credit, invoices).** `OBL-01` is closed and so is the staff half of `OBL-02`; Phase 5 also absorbs and closes ISSUE-168.
>
