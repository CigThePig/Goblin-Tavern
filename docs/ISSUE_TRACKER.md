...
**Waves 0 and 1 are closed** (phases 199 and 200). **Next: Wave 2 — make
causality and closed reports authoritative** (`P4-SEAM-002`, `P6-COMP-006`,
`P5-PLAY-003`, `P4-SEAM-004`, `P5-PLAY-004`, `P7-EXP-003`).
