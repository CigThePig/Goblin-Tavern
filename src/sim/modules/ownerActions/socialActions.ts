...
const comfortStressedStaff: OwnerActionDefinition = {
  ...
  effectsPreview: "Eases a staffer's stress and steadies loyalty",
  pressureAffinity: ['staff_burnout', 'staff_loyalty_risk'],
  targetType: 'staff',
...
const apologizeToRegular: OwnerActionDefinition = {
  ...
  category: 'social',
  tags: ['social', 'regular'],
  effectsPreview: "Mends a regular's standing with the tavern",
...
const negotiateWithSupplier: OwnerActionDefinition = {
  ...
  effectsPreview: 'Improves a supplier relationship and terms',
...
const warnRowdyGroup: OwnerActionDefinition = {
  ...
  effectsPreview: 'Warns a rowdy group off trouble',
...
const hostFactionNight: OwnerActionDefinition = {
  ...
  category: 'social',
  tags: ['social', 'faction'],
  effectsPreview: "Curries favour with a faction's members",
